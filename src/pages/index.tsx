  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the epitome of elegance with Offer - your gateway to the world of luxury goods."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1528154291023-a6525fabe5b4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsdXh1cnl8ZW58MHx8fHwxNjkwOTAzNzcyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the epitome of elegance with Offer - your gateway to the world of luxury goods.`}
            </Text>
            <Box
